...
class WebAuthn(_message.Message):
    __slots__ = ["partial_authenticator_assertion_response"]
    PARTIAL_AUTHENTICATOR_ASSERTION_RESPONSE_FIELD_NUMBER: _ClassVar[int]
    partial_authenticator_assertion_response: bytes
    def __init__(
        self, partial_authenticator_assertion_response: _Optional[bytes] = ...
    ) -> None: ...
