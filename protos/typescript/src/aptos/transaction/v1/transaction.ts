...
export interface WebAuthn {
  partialAuthenticatorAssertionResponse?: Uint8Array | undefined;
}
...
function createBaseWebAuthn(): WebAuthn {
  return { partialAuthenticatorAssertionResponse: new Uint8Array(0) };
}

export const WebAuthn = {
  encode(message: WebAuthn, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (
      message.partialAuthenticatorAssertionResponse !== undefined &&
      message.partialAuthenticatorAssertionResponse.length !== 0
    ) {
      writer.uint32(10).bytes(message.partialAuthenticatorAssertionResponse);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.partialAuthenticatorAssertionResponse = reader.bytes();
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): WebAuthn {
    return {
      partialAuthenticatorAssertionResponse: isSet(object.partialAuthenticatorAssertionResponse)
        ? bytesFromBase64(object.partialAuthenticatorAssertionResponse)
        : new Uint8Array(0),
    };
  },
  ...
  toJSON(message: WebAuthn): unknown {
    ...
    if (
      ...
      obj.partialAuthenticatorAssertionResponse = base64FromBytes(message.partialAuthenticatorAssertionResponse);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<WebAuthn>): WebAuthn {
    const message = createBaseWebAuthn();
    message.partialAuthenticatorAssertionResponse = object.partialAuthenticatorAssertionResponse ?? new Uint8Array(0);
    return message;
  },
};
