...
TESTS = [
    ...
    RunGroupConfig(expected_tps=4000, key=RunGroupKey("resource-groups-global-resource1-kb"), included_in=Flow.LAND_BLOCKING, waived=True),
    RunGroupConfig(expected_tps=8000, key=RunGroupKey("resource-groups-global-resource1-kb", module_working_set_size=20), included_in=Flow(0), waived=True),
    RunGroupConfig(expected_tps=8000, key=RunGroupKey("resource-groups-individual-resource1-kb"), included_in=Flow.CONTINUOUS, waived=True),
    RunGroupConfig(expected_tps=8000, key=RunGroupKey("resource-groups-individual-resource1-kb", module_working_set_size=20), included_in=Flow(0), waived=True),
    RunGroupConfig(expected_tps=8000, key=RunGroupKey("resource-groups-multi-change1-kb"), included_in=Flow.LAND_BLOCKING, waived=True),
    RunGroupConfig(expected_tps=8000, key=RunGroupKey("resource-groups-multi-change1-kb", module_working_set_size=20), included_in=Flow(0), waived=True),
]
# fmt: on
